...
<h2>배송지 등록</h2> 
   <form id="deliveryForm" action="saveDeliveryAddress" method="post">
   		받는 사람: <input type="text" name="name" id="name" required><br><br>
...
<!-- 우편번호 찾기 관련 코드 -->
       	...
       	휴대폰 번호: <input type="number" id="phone" name="phone" placeholder="010-1111-1111" required><br><br>
       	
       	배송 요청사항:<br>
       	 <textarea rows="4" cols="50" name="note" id="note" placeholder="요청사항 입력"></textarea><br><br>
